...
output_path = "/projects/single_cell_stitchit/work/binned_RF/shap_analysis/mc100_1MB500bp_binned_lsi_activity_q100_no_threshold_test_partition_no_scaling_global_top_1000_variable_genes"
#output_path = "/projects/single_cell_stitchit/work/binned_RF/shap_analysis/mc100_1MB500bp_binned_lsi_activity_q0_no_threshold_global"
#output_path = "/projects/single_cell_stitchit/work/binned_RF/shap_analysis/mc150_1MB100bp_binned_lsi_activity_q0_no_threshold_global_top2000"
...
#TODO: mc paths
model_path = "/projects/single_cell_stitchit/work/binned_RF/output/10x_pbmc_10k/meta_cell/cpm_corrected/mc100_1MB500bp_binned_lsi_activity_q0_no_threshold_no_scaling_cpm/models"
#model_path = "/projects/single_cell_stitchit/work/binned_RF/output/10x_pbmc_10k/meta_cell/mc50_1MB100bp_binned_lsi_activity_q0_no_threshold_no_scaling/models"
#model_path = "/projects/single_cell_stitchit/work/binned_RF/output/10x_pbmc_10k/meta_cell/mc100_1MB500bp_binned_lsi_activity_q0_no_threshold_no_scaling/models"
#model_path = "/projects/single_cell_stitchit/work/binned_RF/output/10x_pbmc_10k/meta_cell/mc150_1MB100bp_binned_lsi_activity_q0_no_threshold_no_scaling/models"
#performance_file = "/projects/single_cell_stitchit/work/binned_RF/output/10x_pbmc_10k/meta_cell/mc100_1MB500bp_binned_lsi_activity_q0_no_threshold_no_scaling/mc100_1MB500bp_binned_lsi_activity_q0_no_threshold_performance_correlation.txt"
#performance_file = "/projects/single_cell_stitchit/work/binned_RF/output/10x_pbmc_10k/meta_cell/cpm_corrected/mc50_1MB500bp_binned_lsi_activity_q0_no_threshold_no_scaling_cpm/mc50_1MB500bp_binned_lsi_activity_q0_no_threshold_performance_correlation.txt"
#fmat_path = "/projects/single_cell_stitchit/work/binned_RF/input/paired_PBMC10k/mc100_1MB100bp_binned_lsi_activity_all_features_correct_cb_mc_assignment"
#fmat_path = "/projects/single_cell_stitchit/work/binned_RF/input/paired_PBMC10k/mc100_1MB500bp_binned_lsi_activity_q0"
fmat_path = "/projects/single_cell_stitchit/work/binned_RF/input/paired_PBMC10k/mc100_1MB500bp_binned_lsi_activity_q0"
...
#top_genes_file = "/projects/single_cell_stitchit/work/binned_RF/input/paired_PBMC10k/top_2000_variable_genes_seurat.txt"
#seurat_var_df = pd.read_csv(top_genes_file, sep="\t")
#gene_ids = seurat_var_df['variable_genes'].values
...
fmat_path_0 = os.path.join(fmat_path, f"{gene_ids[0]}_lsi_activity_top_q0.txt.gz")
sc_f_mat = pd.read_csv(fmat_path_0, sep="\t", index_col=0)
cell_ids = sc_f_mat.index

test_cells_file = "/projects/single_cell_stitchit/work/binned_RF/input/paired_PBMC10k/test_meta_cells_100.txt" #training cells as background
...
celltype_df = pd.DataFrame({
    'mc_ids': cell_ids,  
    'celltypes': [x.rsplit('_', 1)[0] for x in cell_ids] 
})
celltype_df_train = celltype_df.iloc[train_idx, :] 
cell_types = celltype_df_train['celltypes'].unique()
...
for gene_id in gene_ids:
    try:    
        ...
        if os.path.exists(out_dir):
            ...
            continue
        model_file = os.path.join(model_path, f"models_{gene_id}_lsi_activity_top_q0_sc_RF_0", f"{gene_id}_lsi_activity_top_q0_sc_RF_0_model.joblib")
        print(model_file)
        if not os.path.exists(model_file):
            print(f"{model_file} does not exist. Skip gene.")
            continue
        #genes.append(gene_id)
        feature_mat_file = os.path.join(fmat_path, f"{gene_id}_lsi_activity_top_q0.txt.gz")
        ...
        df_zscore.to_csv(f"{out_dir}/{gene_id}_zscore_shap_mc_1MB500bp_q0.tsv", sep="\t", index=True, header=True)
        df_shap.to_csv(f"{out_dir}/{gene_id}_shap_mc_1MB500bp_q0.tsv", sep="\t", index=True, header=True)      
